...
public class EnemyFactory implements EntityFactory {
    ...
    public Entity createEntity(
        ...
        try {
            ...
            String color = null;
            if(imageName.equals("slimeBa.png") || imageName.equals("slimeBb.png")){
                color = "blue";
            }
            if(imageName.equals("slimeGa.png") || imageName.equals("slimeGb.png")){
                color = "green";
            }
            if(imageName.equals("slimePa.png") || imageName.equals("slimePb.png")){
                color = "purple";
            }
            if(imageName.equals("slimeRa.png") || imageName.equals("slimeRb.png")){
                color = "red";
            }
            if(imageName.equals("slimeYa.png") || imageName.equals("slimeYb.png")){
                color = "yellow";
            }
